  ...
  return (
    ...
    >
      <div className="p-2">
        ...
        <div>
          <div className="p-7">{data[1]?.[0]?.pitch}</div>

          <p className="text-xl font-bold pl-3">Student will achieve:</p>
          <div className="p-3">{data[1]?.[0]?.curriculum_outcomes}</div>
        </div>
        ...
        <div className="flex justify-around text-xl font-semibold">
          RS {data[1]?.[0]?.discounted_price}
          <span>
            Rs{" "}
            {Math.ceil(
              data[1]?.[0]?.discounted_price / data[1]?.[0]?.num_classes
            )}{" "}
            Per class{" "}
          </span>
        </div>
        ...
        <div className="flex justify-center items-center space-x-11 py-4 bg-color1dark h-5">
          ...
          <div>{data[1]?.[0]?.games_count} Games</div>
          <div>{data[1]?.[0]?.certificate_count} Certificate</div>
        </div>
